...
export default function Contacts() {
  return (
    <div className="numabers">
      <div style={{display:"flex", justifyContent:"center",alignItems:"center"}}><FaInstagram size={40}/><a href={offlineContact.number[0]} style={{textDecoration:"none",color: "#666666"}}>@kupibest</a></div>
